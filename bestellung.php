...
$connectionInfo = array("UID" => "hls", "pwd" => "{!Meppen23}", "Database" => "ibrot2", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
$serverName = "tcp:hls-ibrot2-dbsrv.database.windows.net,1433";
